...
public class GDispData_4b extends JPanel{
    ...
    public GDispData_4b(){
        ...
        dataLbl = new JLabel("Please input the CTD.Data1");
    ...
    public void init(Data1 data1){
        erase();
        this.data1 = data1;
        desLbl.setText(data1.getShrtDesc());
        dataLbl.setText(data1.getShrtDesc());
        model.setRowCount(data1.getClassIntervals());
    }
    ...
    public Data1 getData1() throws Exception{
        ...
        data1.setLowerClassLimits(tempUCL);
        data1.setUpperClassLimits(tempLCL);
        data1.setFrequency(freq);
        return data1;
    }
